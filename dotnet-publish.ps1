...
$csProjServer = "$pwd\src\dotnet\app\Datack.Web.Web\Datack.Web.Web.csproj"
$csProjAgent = "$pwd\src\dotnet\app\Datack.Agent.Service\Datack.Agent.csproj"

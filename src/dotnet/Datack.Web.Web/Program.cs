...
try
{
    ...
    Log.Warning($"****************************************************************************************************************************************************************");
    Log.Warning($"* PASSWORD RESET TOKEN");
    Log.Warning($"* To reset the master password use this token on the login page.");
    Log.Warning($"* {Authentication.PasswordResetToken}");
    Log.Warning($"****************************************************************************************************************************************************************");

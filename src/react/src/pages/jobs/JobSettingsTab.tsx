    ...
    <Loader isLoaded={props.job != null} error={null}>
      <form>
        ...
        <FormControl id="group" marginBottom={4}>
          ...
          <FormHelperText>
            The group for this job. When multiple jobs in the same group try to execute at the same time, only the job
            with the highest priority will start.
            <br />
        ...
        <FormControl id="timeSpan1" marginBottom={4}>
          ...
          <RadioGroup value={deleteLogsTimeSpanType || ''} onChange={(value) => setDeleteLogsTimeSpanType(value)}>
      ...
      <Modal isOpen={showDeleteModal} onClose={handleDeleteCancel} size="lg">
        ...
        <ModalContent>
          ...
          <ModalCloseButton />
          <ModalBody>
            <p>When deleting this job, all tasks, runs and logs will be deleted associated with this job.</p>

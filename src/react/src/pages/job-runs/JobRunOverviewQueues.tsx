          ...
          <Table variant="simple" marginBottom={8}>
            <Tbody>
              ...
              <Tr>
                ...
                <Td>{formatDuration(intervalToDuration({ start: 0, end: queue.totalRunTime * 1000 }))}</Td>
              </Tr>
              <Tr>
              ...
              <Tr>
                ...
                <Td>{queue.firstStart != null ? format(queue.firstStart, 'd MMMM yyyy HH:mm') : 'Never'}</Td>
              </Tr>
              <Tr>
                <Td style={{ fontWeight: 'bold' }}>Last Start</Td>
                <Td>{queue.lastStart != null ? format(queue.lastStart, 'd MMMM yyyy HH:mm') : 'Never'}</Td>
              </Tr>
              <Tr>
              ...
              {queue.longestItem != null && queue.longestRunTime != null ? (
                <Tr>
                  ...
                  <Td>
                    {formatDuration(intervalToDuration({ start: 0, end: queue.longestRunTime * 1000 }))} (
                    {queue.longestItem})
                  </Td>
                </Tr>
              ) : null}
